...
public class DriverHistoryAdapter extends FirestoreRecyclerAdapter<PostsModel,DriverHistoryAdapter.PostsViewHolders> {

    public DriverHistoryAdapter(@NonNull FirestoreRecyclerOptions<PostsModel> options) {
        super(options);
    }
    ...
    public PostsViewHolders onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.driverhistory_item_single, parent, false);
